...
function buildRules() {
  ...
  $('rulesBody').innerHTML = ''
    ...
    + '<p><b>股票：</b>每城 20 股（1 股 = 5%），初始股价 = 地价 ÷ 10 × 2；仅起点可买卖（≤6 股/3 城，单城 2 股、地价≥15000 的城市单次 1 股）；城市所有者最多持有 4 股；购买有主城市股票时所有者得一半收益；持股≥20% 减 10%、≥40% 减 30%、≥60% 减 50% 租金；所有者过起点派发总价值×10% 股息。</p>'
